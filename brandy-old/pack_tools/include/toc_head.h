...
#define  CARD0_GPIO_START     (NAND0_GPIO_START + NAND0_GPIO_MAX)
#define  CARD0_GPIO_MAX       8

#define  CARD2_GPIO_START     (CARD0_GPIO_START + CARD0_GPIO_MAX)
#define  CARD2_GPIO_MAX       16

#define  SPI0_GPIO_START      (CARD2_GPIO_START + CARD2_GPIO_MAX)
#define  SPI0_GPIO_MAX        2
