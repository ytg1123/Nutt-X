...
#define BOOT0_LOAD_KERNEL_BUF                (0x40007fc0)
#define BOOT0_LOAD_KERNEL_ENTRY              (0x40008000)
#define UBOOT_START_SECTOR_IN_SPINOR         (24*1024/512)  //24 also hard code in source code of merge_full_img
#define SYSCONFIG_START_SECTOR_IN_SPINOR     UBOOT_START_SECTOR_IN_SPINOR
#define CONFIG_SPINOR_LOGICAL_OFFSET         ((128 - 16) * 1024/512) //logical offset also hard code as MBR_OFFSET in kernel
...
#define SUNXI_DISPLAY_FRAME_BUFFER_ADDR  (CONFIG_SYS_SDRAM_BASE + 0x03200000)
