...
clk_pll_para disp_clk_pll_tbl[] ={
	...
	PLL_CFG(SYS_CLK_PLL10,		CLK_NONE,		200000000,	0x01c20048,	31,	0,	4,	8,	7,	32, 0, 32, 0)
	PLL_CFG(SYS_CLK_MIPIPLL,	SYS_CLK_PLL3,	0,			0x01c20040,	31, 0,	4,	8,	4,	4,	2, 22, 2)
};

clk_mod_para disp_clk_mod_tbl[] ={
	MOD_CFG(MOD_CLK_DEBE0,		SYS_CLK_PLL10,		100000000,	0x01c20064,	12,	0x01c202c4,	12,	0x01c20100,	26,	0x01c20104,	31,	24,	3,	0,	4)
	MOD_CFG(MOD_CLK_DEFE0,		SYS_CLK_PLL10,		200000000,	0x01c20064,	14,	0x01c202c4,	14,	0x01c20100,	24,	0x01c2010c,	31,	24,	3,	0,	4)
